...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.file_id:
        meta = collector.collect_file(args.file_id, args.tenant, args.source_id)
        ...
        if args.collect_only:
            return 0
        return run_ingest_loop([meta], args.tenant, args.source_id, rag=args.rag, settings=settings)
