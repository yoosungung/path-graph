...
**Wiki VFS (3.2.1)** — 자동: `agents-runtime/deploy/examples/tests/e2e/test_wiki_vfs.sh` (agent-pool `WIKI_S3_*` + general agent invoke). 수동 체크:

- [x] GraphRAG downstream 완료 → S3 `wiki/{tenant}/{project_id}/` 객체 존재
- [x] agent-pool `WIKI_S3_BUCKET`·S3 credential 설정
