...
ARCHITECTURE.md · ROADMAP.md · pipeline v0.1.0 · Admin Console MVP (`path_graph.admin.{projects,sources,lifecycle}`, agents-runtime `/api/pipeline/*` + `/pipeline/*`) · GHA `build-images` → GHCR · `make test` (112 tests).